defmodule RefPA2.UserTest do
  use RefPA2.DataCase

  alias RefPA2.User

  import RefPA2.Factory
  # import Mox
  ...
  #     RefPA2.RequestMock
  #     |> expect(:get, fn "https://refpa2.app/api/users/" <> _id ->
  #       {:ok,
  #        %{
  #          "user" => %{
  #            "id" => user_key.id,
  ...
  #     assert %User{} = User.get_user_from_server(user_key.id, "https://refpa2.app")
  ...
  #     User.get_user_from_server(user_key.id, "https://refpa2.app")
  #   end
  # end
