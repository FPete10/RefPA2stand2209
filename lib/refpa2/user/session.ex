defmodule RefPA2.User.Session do
  @moduledoc """
  ...
  @spec changeset(RefPA2.Session.t(), map) :: Ecto.Changeset.t()
  ...
  @spec valid_access_token?(RefPA2.Session.t(), String.t()) :: boolean
  ...
  @spec valid_refresh_token?(RefPA2.Session.t(), String.t()) :: boolean
  ...
  @spec verify_session(String.t() | nil, String.t() | nil) ::
          {:ok, RefPA2.User.Session.t()} | {:error, String.t()}
  ...
  @spec get_session!(String.t()) :: RefPA2.User.Session.t()
  def get_session!(id) do
    Repo.get!(RefPA2.User.Session, id)
  end

  @doc "Creates a session for a user identified by email and password"
  @spec create_session(String.t(), String.t(), Map.t()) ::
          {:ok, RefPA2.User.Session.t()} | {:error, atom}
  ...
  @doc "Delete session"
  @spec delete_session(RefPA2.User.Session.t()) ::
          {:ok, RefPA2.User.Session.t()}
